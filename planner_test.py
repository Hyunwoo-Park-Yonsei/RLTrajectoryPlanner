...
ego_lat_pos =-0.0807302457041672
ego_lat_speed =   -0.007870999273138706
ego_lat_acc = 0
ego_long_speed =  6.944439983853684
ego_long_acc = 0
oa_pos = [[]] 
oa_speed = []
oa_heading = []
...
optimalTrajectoryPlanner.update(ego_lat_pos, ego_lat_speed, ego_lat_acc, ego_long_speed, ego_long_acc, oa_pos, oa_speed, oa_heading, 48)
